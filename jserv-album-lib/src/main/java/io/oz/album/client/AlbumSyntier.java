 ...
 *
 */
public class AlbumSyntier extends Semantier {

	private ErrorCtx errCtx;
	private String clientUri;

	protected Synclientier worker;
	 ...
	 * @param errCtx
	 */
	public AlbumSyntier(String clientUri, String device, ErrorCtx errCtx) {
		this.errCtx = errCtx;
	...
	public AlbumSyntier getSettings(OnOk onOk, OnError onErr) {
