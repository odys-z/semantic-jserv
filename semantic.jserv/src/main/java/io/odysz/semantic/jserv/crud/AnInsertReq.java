 ...
 * <p>Because all request element is deserialized as an AnUpdateReq,
 * 	so this can only work for Update/Insert request.</p>
 * @author odys-z@github.com
 * @since 1.5.17 replacing io.odysz.semantic.jprotocol.AnInsertReq
 */
