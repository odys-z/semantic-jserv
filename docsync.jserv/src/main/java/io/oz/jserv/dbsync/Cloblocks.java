...
// * <p>Clobs</p>
// * 
// * <p>Clob chain is not guarded with file read-write lock as it's not visible to others
...
//	 * 
//	 * @param uri client function uri
//	 * @param extity table name
//	 * @param tempDir
...
//	 */
//	public Cloblocks(String uri, String Extable, String tempDir, String clientpathRaw, String createDate, String targetFolder)
...
//
//		waitings = new DBSyncReq(uri, Extable).blockSeq(-1);
//	}
//
//	public Cloblocks appendBlock(DBSyncReq blockReq) throws IOException, TransException {
