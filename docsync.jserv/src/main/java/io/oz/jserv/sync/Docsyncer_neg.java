...
// *
// */
//@WebServlet(description = "Document uploading tier", urlPatterns = { "/docs.negative" })
//public class Docsyncer_neg extends ServPort<DocsReq> {
...
//				.post(Docsyncer_neg.onDel(docId, meta, usr))
//				;
//		
...
//		if (Docsyncer_neg.cloudHub.equals(cfg)) {
//			mode = SynodeMode.hub;
//
...
//		}
//		else {
//			if (Docsyncer_neg.mainStorage.equals(cfg))
